...
Route::get('lang/home', [\App\Http\Controllers\Application\LangController::class, 'index']);
Route::get('lang/change', [\App\Http\Controllers\Application\LangController::class, 'change'])->name('changeLang');
